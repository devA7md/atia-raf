...
exports.updateMany = (0, ramda_1.curry)(function (_a, customDataProvider, resource, params) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            ...
            if ((_b = customDataProvider[resource]) === null || _b === void 0 ? void 0 : _b.updateMany) {
                        ...
                        switch (_b.label) {
                            ...
                            case 1:
                                ...
                                for (_i = 0, _a = params.ids; _i < _a.length; _i++) {
                                    id = _a[_i];
                                    batch.update((0, firestore_1.doc)(db, resource, id), (0, utils_1.applyUpdateTimestamp)(params.data));
                                }
