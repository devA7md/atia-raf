...
exports.deleteMany = (0, ramda_1.curry)(function (_a, customDataProvider, resource, params) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            ...
            if ((_b = customDataProvider[resource]) === null || _b === void 0 ? void 0 : _b.deleteMany) {
                        ...
                        switch (_b.label) {
                            ...
                            case 1:
                                ...
                                for (_i = 0, _a = params.ids; _i < _a.length; _i++) {
                                    id = _a[_i];
                                    batch["delete"]((0, firestore_1.doc)(db, resource, id));
                                }
                                return [4 /*yield*/, batch.commit()];
                            case 2:
                                _b.sent();
                                data.push.apply(data, params.ids);
                                return [3 /*break*/, 4];
                            case 3:
                                ex_1 = _b.sent();
                                logger(ex_1.message);
