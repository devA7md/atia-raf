...
exports.getManyReference = (0, ramda_1.curry)(function (_a, customDataProvider, resource, params) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            ...
            if ((_b = customDataProvider[resource]) === null || _b === void 0 ? void 0 : _b.getManyReference) {
                ...
                defaultQuery = function (resource, params) { return __awaiter(void 0, void 0, void 0, function () {
                    var data, target, id, _a, field, order, perPage, filter, queryConstraint, snapshots, ex_1;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                _b.trys.push([1, 3, , 4]);
                                target = params.target, id = params.id, _a = params.sort, field = _a.field, order = _a.order, perPage = params.pagination.perPage, filter = params.filter;
                                queryConstraint = [(0, firestore_1.where)(target, "==", id), (0, firestore_1.limit)(perPage)];
                                if (field !== "id") {
