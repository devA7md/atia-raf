...
exports.create = (0, ramda_1.curry)(function (_a, customDataProvider, resource, params) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            ...
            if ((_b = customDataProvider[resource]) === null || _b === void 0 ? void 0 : _b.create) {
                ...
                defaultQuery = function (resource, params) { return __awaiter(void 0, void 0, void 0, function () {
                    var data, uploadedRefs, uploads, _a, dataWithUploadedFiles, rest, result, ex_1;
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 2:
                                ...
                                return [4 /*yield*/, (0, firestore_1.addDoc)((0, firestore_1.collection)(db, resource), (0, utils_1.applyCreateTimestamp)(dataWithUploadedFiles))];
                            case 3:
                                result = _b.sent();
                                data = { id: result.id };
                                _b.label = 4;
