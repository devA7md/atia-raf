...
exports.deleteQuery = (0, ramda_1.curry)(function (_a, customDataProvider, resource, params) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            ...
            if ((_b = customDataProvider[resource]) === null || _b === void 0 ? void 0 : _b["delete"]) {
                ...
                defaultQuery = function (resource, params) { return __awaiter(void 0, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                _a.trys.push([1, 3, , 4]);
                                return [4 /*yield*/, (0, firestore_1.deleteDoc)((0, firestore_1.doc)(db, resource, params.id))];
                            case 2:
                                _a.sent();
                                data = { id: params.id };
                                return [3 /*break*/, 4];
